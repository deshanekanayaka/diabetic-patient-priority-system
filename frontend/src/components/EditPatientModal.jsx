...
const EditPatientModal = ({ isOpen, onClose, onPatientUpdated, patient }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!res.data.success) {
                const msg = res.data.errors?.length ? res.data.errors.join(', ') : res.data.message || 'Failed to update patient.';
                setApiError(msg);
                return;
            }
        ...
        <>
            ...
            <div className="modal-panel">
                <div className="modal-header">
                    <h2 className="modal-title">Edit Patient — P–{patient.patient_id}</h2>
